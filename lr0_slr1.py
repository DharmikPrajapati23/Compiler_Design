...
#     # Build ordering indices to print S', then S, then A, preserving production order
...
#     ACTION, GOTO, terms, nts, conflicts = build_lr0_table(Glst, S_dash, states, trans)
...
#     if conflicts:
#         print("\nConflicts:")
#         for i, sym, old, new in conflicts:
...
#         if inp:
#             trace = lr0_parse(inp, ACTION, GOTO, terms, nts, states, Glst, S_dash)
#             print("\n{:<20} | {:<15} | {}".format("STATE STACK", "INPUT", "ACTION"))
#             print("-"*60)
#             for stack_str, input_str, act in trace:
#                 print("{:<20} | {:<15} | {}".format(stack_str, input_str, act))
...
#     if lr0_conflicts or slr_conflicts:
#         print("\nGrammar is NOT LR(0) or SLR(1), cannot parse string!")
#     else:
#         inp = input("\nEnter input string to parse (without $): ").strip()
#         if inp:
#             trace = lr0_parse(inp, SLR_ACTION, SLR_GOTO, slr_terms, slr_nts, states, Glst, S_dash)
#             print("\n{:<20} | {:<15} | {}".format("STATE STACK", "INPUT", "ACTION"))
#             print("-"*60)
#             for stack_str, input_str, act in trace:
#                 print("{:<20} | {:<15} | {}".format(stack_str, input_str, act))
